          ...
          >
            ...
            >
              <img
                ...
                width="120"
                height="60"
                /* CHANGED: הקטנתי רק את ה-heights של הלוגו בכל ברייקפוינט (~20% פחות) */
                className="h-[32px] sm:h-[40px] lg:h-[48px] xl:h-[55px] 2xl:h-[64px] w-auto object-contain drop-shadow-xl transition-transform hover:scale-105"
              />
            </a>
          </div>
