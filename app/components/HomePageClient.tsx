    ...
    <div className="min-h-screen bg-black">
        ...
        <div className="relative z-10 w-full px-4 sm:px-6 max-w-7xl mx-auto">
          <div className="flex flex-col items-center justify-center min-h-screen py-20 text-center">
            ...
            <p className="mb-8 max-w-2xl text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 animate-slide-up animation-delay-200 px-4">
              Get Professional Agency Results at 90% Less Cost - Complete Campaign Creation, Management & Optimization on Autopilot.
              <a href="/faq" className="text-purple-400 hover:text-purple-300 underline ml-1">See how we compare to agencies</a>
            </p>
            {/* Trust Indicators */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="space-y-2">
              ...
              <div className="text-sm text-gray-400">ROI vs Agencies</div>
            </div>
            <div className="space-y-2">
              <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
                500+
              </div>
              <div className="text-sm text-gray-400">Businesses Saved</div>
            </div>
            <div className="space-y-2">
              <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
                24/7
      ...
      >
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">Stop Funding Your Competitors' Marketing Agencies</h2>
          <p className="max-w-2xl mx-auto text-lg text-gray-300 mb-8">
            While you pay agencies $15K/month, smart competitors are using MONONIO for $297/month and eating your market share
          </p>
